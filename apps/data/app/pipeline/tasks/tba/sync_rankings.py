...
def sync_rankings(event_filter: EventFilter = "all"):
    logger = get_run_logger()

    logger.info(f"Starting rankings sync from The Blue Alliance for {event_filter}")
    ...
    logger.info(f"Rankings sync completed successfully for {event_filter}")
